package com.cip.yerayplasenciaramos.calculadora;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCambioSigno = (Button) findViewById(R.id.CambioSigno);
        ...
        btnCambioSigno.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                mostrar = Resultado.getText().toString();
                if (mostrar.equals("0") || mostrar == null){
                    mostrar = "";
                }
                if (mostrar.length()>=1 && mostrar.substring(0,1).equals("-")){
